...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙏𝙊𝙊𝙇𝙎 𝙎𝙏𝘼𝙏𝙐𝙎\033[1;34m: [★]𝗣𝗥𝗜𝗠𝗜𝗨𝗠\033[1;39m             ┃
 \033[1;39m    ┗━━━━━━━━━━━━━━━━━━━\033[1;31mTEAMX\033[1;39m━━━━━━━━━━━━━━━━━━━━┛"""
loop = 0
oks = []
cps = []
...
try:
    ...
    update = ('5.2')
    if str(v) in update:
        os.system('xdg-open https://www.facebook.com/groups/1921046971256696/')
    else:pass
...
def news():
    ...
    os.system("clear")
    print(logo)
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;93m Example \033[1;91m>>\033[1;92m 0171 \033[1;91m<>\033[1;92m 0175 <<\033[1;92m 0177')
    print('\033[1;94m<><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><><')
